...
# TODO Добавить иконки приложения
# TODO сделать вывод диалогового откна с тестами(+редизайн)
# TODO подумать над отрицательными числами
...
class Num_Translate(QMainWindow):
    def __init__(self):
        ...
        uic.loadUi("NumTranslator.ui", self)  # ПОДГРУЗКА ИНТЕРФЕЙСА
...
class Test_dialog(QDialog):
    def __init__(self, n, num, fss, iss):
        super().__init__()
        uic.loadUi("test_dialog.ui", self)
...
class Mark_dialog(QDialog):
    def __init__(self, mark):
        super().__init__()
        uic.loadUi("mark_dialog.ui", self)
...
class Error(QDialog):
    def __init__(self, error_code):
        super().__init__()
        uic.loadUi("ss_error_dialog.ui", self)
